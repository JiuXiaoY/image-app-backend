...
public class UserController {
    ...
    public BaseResponse<Long> register(@RequestBody UserDto dto) {
        ThrowUtils.throwIf(ObjectUtil.isNull(dto), ErrorCode.PARAMS_ERROR);
        String userAccount = dto.getUserAccount();
        String userPassword = dto.getUserPassword();
        String checkPassword = dto.getCheckPassword();
        long registerRes = userService.userRegister(userAccount, userPassword, checkPassword);
        return ResultUtils.success(registerRes);
    }

    @PostMapping("/login")
    public BaseResponse<LoginUserVo> userLogin(@RequestBody UserDto dto, HttpServletRequest request) {
        ThrowUtils.throwIf(ObjectUtil.isNull(dto), ErrorCode.PARAMS_ERROR);
        String userAccount = dto.getUserAccount();
        String userPassword = dto.getUserPassword();
    ...
    public BaseResponse<Long> addUser(@RequestBody UserDto userAddRequest) {
    ...
    public BaseResponse<UserVo> getUserVOById(long id) {
        ...
        return ResultUtils.success(User.convert2UserVo(user));
    }
    ...
    @PostMapping("/delete")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> deleteUser(@RequestBody UserDto deleteRequest) {
    ...
    @PostMapping("/update")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> updateUser(@RequestBody UserDto userUpdateRequest) {
    ...
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Page<UserVo>> listUserVOByPage(@RequestBody UserDto userQueryRequest) {
        ...
        List<UserVo> userVoList = User.convert2UserVoList(userPage.getRecords());
