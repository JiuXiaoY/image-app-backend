...
import com.ai.imageagent.filesaver.CodeFileSaverExecutor;
import com.ai.imageagent.parser.CodeParserExecutor;
    ...
    private Flux<String> processTokenStream(TokenStream tokenStream, Long appId) {
        return Flux.create(sink -> tokenStream.onPartialResponse((String partialResponse) -> {
                ...
                .onCompleteResponse((ChatResponse response) -> {
                    ...
                    vueProjectBuilderTool.buildProjectAsync(ProjectPath, VueProjectBuildToolEnum.PNPM_MODE);
                    sink.complete();
                })
