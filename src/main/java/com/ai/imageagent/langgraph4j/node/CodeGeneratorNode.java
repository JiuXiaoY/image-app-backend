package com.ai.imageagent.langgraph4j.node;

import com.ai.imageagent.ai.AiCodeGeneratorFacade;
import com.ai.imageagent.constant.AppConstant;
import com.ai.imageagent.constant.BlockingTimeouts;
import com.ai.imageagent.domain.aimodel.CodeGenTypeEnum;
import com.ai.imageagent.langgraph4j.model.QualityResult;
import com.ai.imageagent.langgraph4j.state.WorkflowContext;
import com.ai.imageagent.utils.SpringContextUtil;
...
public class CodeGeneratorNode {
    ...
    public static AsyncNodeAction<MessagesState<String>> create() {
        return node_async(state -> {
            ...
            // 同步等待流式输出完成
            codeStream.blockLast(Duration.ofMinutes(BlockingTimeouts.VERY_LONG.toMinutes())); // 最多等待 10 分钟
            // 根据类型设置生成目录
