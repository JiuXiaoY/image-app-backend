package com.ai.imageagent.langgraph4j;
...
import com.ai.imageagent.langgraph4j.node.*;
...
public class CodeGenWorkflow {
    ...
    @Resource(name = "agentModeExecutor")
    private ThreadPoolExecutor agentModeExecutor;
        ...
        return Flux.create(sink -> {
            agentModeExecutor.submit(() -> {
                try {
                    ...
                    log.error("代码生成工作流执行出错:{}", e.getMessage());
                    sink.error(e);
                }
            });
        });
