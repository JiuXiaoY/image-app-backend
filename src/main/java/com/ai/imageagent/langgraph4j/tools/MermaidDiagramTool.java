package com.ai.imageagent.langgraph4j.tools;
...
import com.ai.imageagent.langgraph4j.state.ImageCategoryEnum;
import com.ai.imageagent.langgraph4j.state.ImageResource;
...
public class MermaidDiagramTool {
    ...
    private File convertMermaidToSvg(String mermaidCode) {
        ...
        // 执行命令
        String s = RuntimeUtil.execForStr(cmdLine);
        log.info("Mermaid CLI 输出: {}", s);
        // 检查输出文件
    ...
    private File convertMermaidToSvgWithSpecifiedChromePath(String mermaidCode) {
        ...
        try {
            ...
            pb.environment().put("PUPPETEER_EXECUTABLE_PATH", AppConstant.CHROME_PATH_FOR_LINUX);
